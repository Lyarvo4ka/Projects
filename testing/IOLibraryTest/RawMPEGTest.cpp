...
BOOST_AUTO_TEST_CASE(RawMPEG_calcMpegBlockSize_test)
{
	...
	IO::RawMPEG mpeg_raw(src_file);

	auto mpeg_block_size = mpeg_raw.calcMpegBlockSize(0);
	BOOST_CHECK_EQUAL(mpeg_block_size , 131072);

	BOOST_CHECK_EQUAL(mpeg_raw.Specify(0), true);
