...
//#include "..\Epos Imager\resource.h"
...
BEGIN_MESSAGE_MAP(CGridListCtrlEx, CListCtrl)
	...
	//ON_WM_RBUTTONUP()	// OnRButtonUp(UINT nFlags, CPoint point)
...
int CGridListCtrlEx::GetSelectedRow() const
{
...
//void CGridListCtrlEx::OnRButtonUp(UINT nFlags, CPoint point)
//{
//	TRACE("Right button up\r\n");
//	CListCtrl::OnContextMenu(this,point);
...
void CGridListCtrlEx::DeleteColumn(int _iCol)
{
	this->DeleteColumnTrait(_iCol);
}
...
{
	//HWND MainHWND = AfxGetApp()->GetMainWnd()->GetSafeHwnd();
	//ASSERT(MainHWND);
	//::SendMessage(MainHWND,SEND_CONTEXT_MENU,NULL,NULL);
	//::TRACE("On Context Menu cell\r\n");
	m_iRowSelected = nRow;
