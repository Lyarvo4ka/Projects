...
#define DM_SEND_COMMAND_DELAY						(DWORD)100				// Çàäåðæêà ïåðåä ïåðåñûëêîé ïàðàìåòðà
#define DM_SEND_TASK_DELAY							(DWORD)10*1000			// Çàäåðæêà ïåðåä ïîëó÷åíèåì DETECT_INFO
#define DM_RESPONSE_TIMEOUT							(DWORD)3*60*1000		// Âðåìÿ â òå÷åíèè êîòîðîãî äîëæåí îòâåòèòü "USB DiskMaster"
			...
			case kMsgTaskInfo:
				if (sizeof(DM_TASK_INFO) == io->Read(&task_info, sizeof(DM_TASK_INFO))) {
					...
					case kEndCodeTaskCrcErrorEnd:
						//
						// Â äàííîì ìåñòå íàäà óâåäîìèòü âñåõ ïîäïèñ÷èêîâ î çàâåðøåíèè òàñêà,
