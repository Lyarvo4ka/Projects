...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SelectWindow_t, stringdata) + ofs \
...
const QMetaObject SelectWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SelectWindow.data,
      qt_meta_data_SelectWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SelectWindow.stringdata))
